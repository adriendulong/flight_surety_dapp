...
contract('Oracles', async (accounts) => {
  ...
  it('can request flight status', async () => {
    ...
    //       response = await flightSuretyApp.submitOracleResponse(oracleIndexes[idx], firstAirline, flight, timestamp, STATUS_CODE_ON_TIME, { from: accounts[a] });
    ...
    // expect(status).to.be.bignumber.equal(new BN(STATUS_CODE_ON_TIME));
  });
